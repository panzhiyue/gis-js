...
title: Vue2olSourceVectortile

---

# Vue2olSourceVectortile

> ol/source/VectorTile 的 vue 组件
...
| 名称   | 属性                                                               | 描述                     |
| ------ | ------------------------------------------------------------------ | ------------------------ |
| init   | **mapObject** `import('ol/source/VectorTile').default` - 地图元素  | 地图元素初始化完时触发   |
| append | **mapObject** `import('ol/source/VectorTile').default` - 地图元素  | 地图元素添加到地图时触发 |
| ready  | **mapObject** `import('ol/source/VectorTile').default` - undefined | 组件就绪时触发           |
