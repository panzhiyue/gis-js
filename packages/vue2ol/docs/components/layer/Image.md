...
title: Vue2olLayerImage

---

# Vue2olLayerImage

> ol/layer/Image 的 vue 组件
...
| 名称   | 属性                                                        | 描述                     |
| ------ | ----------------------------------------------------------- | ------------------------ |
| init   | **mapObject** `import('ol/layer/Image').default` - 地图元素 | 地图元素初始化完时触发   |
| append | **mapObject** `import('ol/layer/Image').default` - 地图元素 | 地图元素添加到地图时触发 |
| ready  | **mapObject** `import('ol/layer/Image').default` - 地图元素 | 组件就绪时触发           |
