...
function createAssetPluginHooks(assetsById, outputBundle, assetFileNames) {
    function emitAsset(name, dependenciesOrSource, source) {
        ...
        if (Array.isArray(dependenciesOrSource)) {
            ...
            dependencies = dependenciesOrSource.map(function (depId) { return normalize(path.resolve(depId)); });
        }
...
function createFilter ( include, exclude ) {
	const getMatcher = id => ( isRegexp$1( id ) ? id : { test: micromatch_1.matcher( path.resolve( id ) ) } );
...
var Task = /** @class */ (function () {
    ...
    Task.prototype.run = function () {
        ...
        return rollup(options)
            ...
            _this.cache.assetDependencies.forEach(function (assetDep) {
                watched.add(assetDep);
                _this.watchFile(assetDep);
            });
            ...
            if (_this.cache) {
                ...
                if (_this.cache.assetDependencies) {
                    _this.cache.assetDependencies.forEach(function (assetDep) {
                        _this.watchFile(assetDep);
                    });
                }
