/**
 * @module utilscesium/Draw/Polyline
 */
 ...
 * @api
 */
 class Polyline extends DrawModel {
    ...
    constructor(opt_options) {
        ...
        */
         ...
         * @type {boolean}
         */
        this.enableRight_ = options.enableRight;
        ...
        this.geometryType = PlotTypes.POLYGON;
    }
    ...
    */
    setActive(bool) {
        ...
        if (bool) {
            ...
            }.bind(this), Cesium.ScreenSpaceEventType.RIGHT_DOWN);
            ...
            }.bind(this), Cesium.ScreenSpaceEventType.RIGHT_UP);
            ...
            this.handler_.setInputAction(function (event) {
                ...
                let positions = this.inputPositions_.concat();
    ...
    stopDraw_() {
        //触发结束绘制事件
        this.drawEnd.raiseEvent({ type: "drawEnd", positions: this.calcPositions_(this.inputPositions_), inputPositions: this.inputPositions_ });
        //清空临时对象
        this.positions_ = [];
        this.inputPositions_ = [];
        this.viewer_.entities.remove(this.entity_);
