  ...
  setActive(bool) {
    ...
    if (bool) {
      ...
      this.handler_.setInputAction(
        function(event) {
          ...
          if (!this.entity_) {
            ...
            this.entity_.ellipse.semiMinorAxis = new Cesium.CallbackProperty(
              function() {
                return this.radius_;
              }.bind(this),
              false
            );
            this.entity_.ellipse.semiMajorAxis = new Cesium.CallbackProperty(
              function() {
                return this.radius_;
              }.bind(this),
              false
      ...
      this.handler_.setInputAction(
        function(event) {
          if (
            !Cesium.defined(this.position_) ||
            !Cesium.defined(this.radius_)
          ) {
            return;
          }
