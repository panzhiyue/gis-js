...
let m = new Cesium.ImageMaterialProperty({
    image: "./resources/img/default.jpg", //图片
    repeat: new Cesium.Cartesian2(3, 2), //重复
    color: Cesium.Color.RED, //应用于图像的颜色
    transparent: true //当图像具有透明度时设置为 true（例如，当 png 具有透明部分时）
