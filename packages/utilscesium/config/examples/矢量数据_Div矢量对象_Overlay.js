...
const overlayManager = new utilscesium.Manager.OverlayManager({
  viewer: viewer,
});
...
let overlay = new utilscesium.Overlay({
  element: element,
  offset: [0, -60],
  positioning: "bottom-center",
});
overlayManager.addOverlay(overlay);
overlay.setPosition(Cesium.Cartesian3.fromDegrees(120, 28));
