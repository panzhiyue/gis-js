...
var vue2ol = require('@gis-js/vue2ol');
var TileImage = require('ol/source/TileImage');
...
var script$6 = {
  ...
  inheritAttrs: false,
  components: {
    Vue2olOverlay: vue2ol.Vue2olOverlay,
  },
  props: {
    /**
  ...
  mounted() {
    if (this.parentMap) {
      ...
      this.parent = vue2ol.findRealParent(this.$parent).mapObject;
    }
...
var script$3 = {
  ...
  mixins: [vue2ol.TileImageSourceMixin],
  data() {
    return {
      newUrl: "",
    };
  ...
  mounted() {
    ...
    let options = vue2ol.optionsMerger(
      {
    ...
    //初始化view对象
    this.mapObject = new TileImage__default["default"](options);

    //绑定事件
    vue2ol.bindListeners(this.mapObject, vue2ol.getListeners(this));
    //监听props属性
    vue2ol.propsBinder(this, this.mapObject, this.$options.props);
...
var script$2 = {
  ...
  mixins: [vue2ol.XYZSourceMixin],
  components: {
    Vue2olSourceXyz: vue2ol.Vue2olSourceXyz,
  },
  data() {
    return {};
  },
...
exports.Vue2olControlMouseinfo = __vue_component__$5;
exports.Vue2olControlMousetips = __vue_component__$6;
exports.Vue2olControlPopup = __vue_component__$4;
exports.Vue2olSourceBaidu = __vue_component__$3;
exports.Vue2olSourceBing = __vue_component__$2;
exports.Vue2olSourceGaoDe = __vue_component__$1;
exports.Vue2olSourceGeoQ = __vue_component__;
exports["default"] = API;
