...
| coordinates | 坐标。<br/>`@typeName` {Array<import('ol/coordinate').Coordinate>}                                                                                    | array  | -        |        |

## Events

| 名称  | 属性                                                             | 描述           |
| ----- | ---------------------------------------------------------------- | -------------- |
| ready | **mapObject** `import('ol/geom/MultiPoint').default` - undefined | 组件就绪时触发 |
